...
public class Steering : MonoBehaviour
{
    ...
    void Start()
    {
        rectT = WheelSprite.rectTransform;
        InitEventsSystem();
    }
    ...
    void InitEventsSystem()
    {
        ...
        // You are warned!
        EventTrigger events = WheelSprite.gameObject.GetComponent<EventTrigger>();

        if (events == null)
            events = WheelSprite.gameObject.AddComponent<EventTrigger>();
